      ...
      <section className="section">
        <div className="container">
          <div className="block">
            ...
            <h2 className="subtitle mb-4">Kontakt-Adresse</h2>
            ...
            <h2 className="subtitle mb-4">Vertretungsberechtigte Person(en)</h2>
            <p className="content mb-5">Pascal Matter, Präsident</p>

            <h2 className="subtitle mb-4">Haftungsausschluss</h2>
            ...
            <h2 className="subtitle mb-4">Haftungsausschluss für Links</h2>
            ...
            <h2 className="subtitle mb-4">Urheberrechte</h2>
